...
|---|---|---|---|---|---|
| before_plan | before G2 completion | Record skill activation, tool reality, Dependency Decision, implementation path, validation strategy, and writing-plans decision. | pass | file:examples/delivery-runs/passing/plan.md | |
