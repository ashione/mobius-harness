...
Show a complete plan gate for an exception fixture.
...
|---|---|---|---|---|---|
| before_plan | before G2 completion | Record skill activation, tool reality, Dependency Decision, implementation path, validation strategy, and writing-plans decision. | pass | file:examples/delivery-runs/exception/plan.md | |
...
|---|---|---|---|
| Fixture plan accepted | Exception validator example | file:examples/delivery-runs/exception/plan.md | decision:fixture |
...
Run `bash scripts/validate-delivery-run.sh examples/delivery-runs/exception`.

## Acceptance Criteria

Validator exits successfully with an accepted exception.
